...
## Project Overview
InStockTracker is a Kotlin Multiplatform project designed to track inventory across multiple platforms. The application consists of:
...
**Important**: All UI development must strictly follow these design specifications. Before making any changes to the UI, consult the design files in the `/designs` folder. Additional design files may be added in the future.
...
5. After review and approval, merge into the main branch

## Future Development
- Implementation of inventory tracking features
